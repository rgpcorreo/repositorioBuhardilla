...
<head>
    ...
    <meta name="author" content="rgpcorreo">

    <title>Gestion - Acceso de usuario</title>
...
<div class="container">
    <div class="row">
        <div class="col-md-offset-5 col-md-4 text-center">
            <h1 class='text-white'>Acceso de usuario</h1>
              <div class="form-login"></br>
                ...
                <div class="wrapper">
                        <span class="group-btn">
                            <a href="#" class="btn btn-danger btn-md">acceder <i class="fa fa-sign-in"></i></a>
                        </span>
                </div>
            </div>
        </div>
